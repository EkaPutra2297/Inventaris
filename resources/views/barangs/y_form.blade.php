...
<html lang="en">
  ...
  <body>
    <div class="row clearfix">
        ...
        <div class="col-md-3">
            <input class="form-control" type="text" name="Nama_Barang" value="{{ $model->Nama_Barang }}"> 
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-3">
            <input class="form-control"  type="text" name="Harga"  value="{{ $model->Harga }}">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-3">
            <input class="form-control"  type="text" name="Supplier"  value="{{ $model->Supplier }}">
